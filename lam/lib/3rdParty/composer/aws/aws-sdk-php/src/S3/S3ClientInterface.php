 ...
 *         OptionalFields?: list<'BucketKeyStatus'|'ChecksumAlgorithm'|'ETag'|'EncryptionStatus'|'IntelligentTieringAccessTier'|'IsMultipartUploaded'|'LastModifiedDate'|'LifecycleExpirationDate'|'ObjectAccessControlList'|'ObjectLockEventHoldDuration'|'ObjectLockEventHoldStatus'|'ObjectLockLegalHoldStatus'|'ObjectLockMode'|'ObjectLockRetainUntilDate'|'ObjectOwner'|'ReplicationStatus'|'Size'|'StorageClass'>,
 ...
 *         RetainUntilDate?: int|string|\DateTimeInterface,
 *         EventHold?: 'OFF'|'ON',
 *         EventHoldDuration?: array{Days?: int, Years?: int, ...},
 *         ...,
 *     },
 *     RequestPayer?: 'requester',
 *     VersionId?: string,
