 ...
 *
 * HibcQrCode Barcode type class
 * HIBC in QR Code (ANSI/HIBC 2.6 and ANSI/HIBC 1.3)
 *
 * QR Code symbol carrying a Health Industry Bar Code data structure. The input
 ...
 * @link        https://github.com/tecnickcom/tc-lib-barcode
 */
class HibcQrCode extends \Com\Tecnick\Barcode\Type\Square\QrCode
{
    use HibcPayload;
