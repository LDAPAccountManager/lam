...
$account = new Account();
$account->general_username = "mam2";
$account->general_uidnumber = "502";
$account->general_surname = "Mustermann";
$account->general_givenname = "Max";
$account->general_group = "tg1";
$account->general_groupadd = array("tg3");
$account->general_homedir = "/home/m/mamu2";
$account->general_shell = array("/bin/bash","/bin/sh");
$account->unix_password = "secret2";
$account->unix_password_no = "1";
array_push($accounts,$account);
$account = new Account();
$account->general_username = "mamu3";
$account->general_uidnumber = "503";
$account->general_surname = "Mustermann";
$account->general_givenname = "Max";
array_push($accounts,$account);
